export default function ClassPassConfirmation({ cpSession, onDone, isReturning }) {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center bg-gray-100 px-6">
      <div className="flex w-full max-w-sm flex-col items-center gap-3 rounded-2xl bg-white px-8 py-10 text-center shadow-xl">
        ...
        <p className="text-base text-gray-700">
          {isReturning
            ? 'Your check-in has been logged. Please step up to the front desk to verify your ClassPass booking.'
            : 'Please step up to the front desk so we can verify your ID and ClassPass booking.'}
        </p>
        <p className="text-sm text-gray-400">{cpSession.guestName}</p>
